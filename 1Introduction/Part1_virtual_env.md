...
Si vous lancer les notebook depuis powershell et que vous avez une erreur sur votre naviguateur, copiez coller le lien localhost que la commande vous a donné, directement dans votre naviguateur
